			...
			<div class="nav-tabs-custom">
				<div class="box-body">
              	<table id="" class="table table-bordered table-hover">
              		...
              		<tr>
              			<th>时间频度</th>
              			<td>
              				<input type="radio" name="period"/>今天&nbsp;&nbsp;&nbsp;
              				<input type="radio" name="period"/>昨天&nbsp;&nbsp;&nbsp;
              				<input type="radio" name="period"/>最近30天&nbsp;&nbsp;&nbsp;
              			</td>
              		</tr>
              		<tr>
              			<th>分析</th>
              			<td>
              				<input type="radio" name="ansy"/>指标分析&nbsp;&nbsp;&nbsp;
              				<input type="radio" name="ansy"/>入口分析&nbsp;&nbsp;&nbsp;
              				<input type="radio" name="ansy"/>退出页分析&nbsp;&nbsp;&nbsp;
              			</td>
              		</tr>
              		<tr>
              			<th>URL查询</th>
              			<td>
              				<input type="text"  value=""/><input type="button"  value="查询"/>
              			</td>
              		</tr>
              		</tbody>
              	</table>
                ...
                <div class="box-body">
                  <table id="" class="table table-bordered table-hover">
                    ...
                    <tbody>
                      <tr>
                        <td>https://www.jointforce.com/home</td>
                        <td>5000</td>
                        <td>1000</td>
                        <td> 500</td>
                        <td>100</td>
